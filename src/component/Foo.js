                ...
                <tr className='footer-tr'>
                    ...
                    <td className="footer-td2">
                        ...
                        <ul className="footer-ul">
                           <Link to='/' className='footer-link'> <li className="footer-li" >Home</li></Link>
                           <Link to='/page' className='footer-link'><li className="footer-li" >About Us</li></Link> 
                          <Link to='/room' className='footer-link'>  <li className="footer-li" >Rooms & Suites</li></Link>
                          <Link to='reservation' className='footer-link'>  <li className="footer-li" >News & Events</li></Link>
                           <Link to='blog' className='footer-link'> <li className="footer-li" >Contacts</li></Link>
